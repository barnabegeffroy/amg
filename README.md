...
- horizontal scrolling support for newsletter section (coming soon)
- about section (different from the timeline) -->

The Jekyll structure of this theme includes:

- `_newsletter` files - what generate the newsletter grid. YAML front matter handles all the details
